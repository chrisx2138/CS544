...
def client_mode(args):
    ...
    asyncio.run(quic_engine.run_client(server_address, server_port, config, username))
...
def parse_args():
    ...
    client_parser.add_argument('-u', '--username', required=True, help='Username for the client')
